 ...
 *
 */
public class JeuPlaneteH_2 implements Runnable {

    public JeuPlaneteH_2(Joueur j1, Joueur j2, int nblignes, int nbcols) {
    ...
    public void run() {
        ...
        while (gagnant == 0 && grille.nbLibre() > 0 && !forceStop) {
            ...
            if (depassement[nextjoueur] > depassementPermis) {
                ...
                if (!ignorerRetard && !(joueurs[nextjoueur] instanceof FenetrePlaneteH_2.JoueurGUI)) {
    ...
    public void setIgnorerRetard(boolean ignoreretard) {
        this.ignorerRetard = true; //TODO decommenter
    ...
    public static void main(String args[]) throws Exception {
        ...
        JeuPlaneteH_2 gp = new JeuPlaneteH_2(j1, j2, 14, 14);
        gp.run();
